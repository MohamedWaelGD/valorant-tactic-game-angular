...
@Component({
  selector: 'app-weapons-shop',
  templateUrl: './weapons-shop.component.html',
  styleUrls: ['./weapons-shop.component.css']
})
export class WeaponsShopComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.httpRequestService.getAllWeapons().subscribe(result => {
      console.log(result);
      var data = JSON.parse(result.data);
      this.weaponList = data.data;
  ...
  openModal(weapon:Weapon, content:any) {
    this.httpRequestService.getWeapon(weapon.uuid).subscribe(result => {
