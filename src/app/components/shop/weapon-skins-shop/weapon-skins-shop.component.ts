...
@Component({
  selector: 'app-weapon-skins-shop',
  templateUrl: './weapon-skins-shop.component.html',
  styleUrls: ['./weapon-skins-shop.component.css']
})
export class WeaponSkinsShopComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.httpRequestService.getAllWeaponSkins().subscribe(result => {
      console.log(result);
      var data = JSON.parse(result.data);
      this.weaponSkinList = data.data;
      console.log(this.weaponSkinList);
    });
  }
  ...
  openModal(weapon:WeaponSkin, content:any) {
    console.log(weapon.uuid);
    this.httpRequestService.getWeaponSkin(weapon.uuid).subscribe(result => {
      console.log(result);
      this.selectedWeapon = weapon;
      this.selectedWeapon.price = result.data.price;
